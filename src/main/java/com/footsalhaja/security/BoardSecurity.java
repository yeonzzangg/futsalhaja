...
public class BoardSecurity {
	...
	public boolean checkWriter2(String userName, int ab_number) {
		com.footsalhaja.domain.academy.BoardDto academyboard = academyMapper.select(ab_number);
		
		return academyboard.getMember_userId().equals(userName);
	}
}
